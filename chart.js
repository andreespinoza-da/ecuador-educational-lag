...
const translations = {
  es: {
    ...
    subtitle:       'La <strong>Tasa Bruta de Asistencia (TBA)</strong> cuenta a todos los alumnos que asisten a un nivel educativo sin importar su edad. La <strong>Tasa Neta (TNA)</strong> cuenta solo a quienes tienen la edad oficial para ese nivel. La brecha entre ambas —la banda sombreada— revela la proporción de estudiantes con rezago: personas asistiendo a un nivel que deberían haber superado.',
